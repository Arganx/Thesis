...
Items::Items()
{
	...
	types[0]= ItemType("Zwoj", 5, 4, 1, 1, 0,"./src/textures/Daily Doodles - Pixel Art Asset Pack/magic07scroll.png",4);
	types[1] = ItemType("Miecz", 3, 3, 5, 3, 5, "./src/textures/Daily Doodles - Pixel Art Asset Pack/weapon01crystalsword.png", 5);
	types[2] = ItemType("Sztylet", 2, 0, 4, 3, 1, "./src/textures/Daily Doodles - Pixel Art Asset Pack/weapon02dagger.png", 6);
	types[3] = ItemType("Topor", 3, 0, 4, 3, 2, "./src/textures/Daily Doodles - Pixel Art Asset Pack/weapon05doubleaxe.png", 7);
	types[4] = ItemType("Plaszcz", 4, 3, 2, 1, 2, "./src/textures/Daily Doodles - Pixel Art Asset Pack/armour01magiciansrobe.png", 8);
	types[5] = ItemType("Lekki Pancerz", 4, 0, 2, 1, 0, "./src/textures/Daily Doodles - Pixel Art Asset Pack/armour02whiteshirt.png", 9);
	types[6] = ItemType("Ciezki Pancerz", 6, 2, 1, 2, 6, "./src/textures/Daily Doodles - Pixel Art Asset Pack/armour03velvetoutfit.png", 10);
	types[7] = ItemType("Kolczuga", 4, 0, 2, 2, 2, "./src/textures/Daily Doodles - Pixel Art Asset Pack/armour04chainmail.png", 11);
	types[8] = ItemType("Kaptur", 4, 1, 3, 1, 2, "./src/textures/Daily Doodles - Pixel Art Asset Pack/armour05monksrobe.png", 12);
	types[9] = ItemType("Zbroja", 5, 0, 4, 0, 4, "./src/textures/Daily Doodles - Pixel Art Asset Pack/armour05platemail.png", 13);
	types[10] = ItemType("Kurtka", 4, 1, 4, 0, 1, "./src/textures/Daily Doodles - Pixel Art Asset Pack/armour07leatherjerkin.png", 14);
	types[11] = ItemType("Niebieska roslina", 1, 3, 6, 2, 1, "./src/textures/Daily Doodles - Pixel Art Asset Pack/berry01blue.png", 15);
	types[12] = ItemType("Zolta roslina", 1, 4, 6, 2, 1, "./src/textures/Daily Doodles - Pixel Art Asset Pack/berry02yellow.png", 16);
	types[13] = ItemType("Fioletowa roslina", 1, 5, 6, 2, 1, "./src/textures/Daily Doodles - Pixel Art Asset Pack/berry03purple.png", 17);
	types[14] = ItemType("Czerwona roslina", 1, 1, 6, 2, 1, "./src/textures/Daily Doodles - Pixel Art Asset Pack/berry04red.png", 18);
	types[15] = ItemType("Zwykly miecz", 3, 0, 3, 3, 2, "./src/textures/Daily Doodles - Pixel Art Asset Pack/weapon03longsword.png", 19);
	types[16] = ItemType("Kiscien", 4, 6, 6, 1, 3, "./src/textures/Daily Doodles - Pixel Art Asset Pack/weapon04rustyflail.png", 20);
	types[17] = ItemType("Luk", 4, 4, 5, 3, 2, "./src/textures/Daily Doodles - Pixel Art Asset Pack/weapon06bow.png", 21);
	types[18] = ItemType("Wlocznia", 2, 6, 2, 1, 3, "./src/textures/Daily Doodles - Pixel Art Asset Pack/weapon07spear.png", 22);
	types[19] = ItemType("Naszyjnik", 3, 2, 5, 1, 2, "./src/textures/Daily Doodles - Pixel Art Asset Pack/magic06necklace.png", 23);
	types[20] = ItemType("Rozdzka", 2, 6, 0, 2, 2, "./src/textures/Daily Doodles - Pixel Art Asset Pack/magic05wand.png", 24);
	types[21] = ItemType("Pierscien", 3, 4, 2, 0, 3, "./src/textures/Daily Doodles - Pixel Art Asset Pack/magic04ring.png", 25);
	types[22] = ItemType("Kula", 2, 1, 1, 0, 4, "./src/textures/Daily Doodles - Pixel Art Asset Pack/magic03orb.png", 26);
	types[23] = ItemType("Ksiazka", 4, 3, 2, 0, 0, "./src/textures/Daily Doodles - Pixel Art Asset Pack/magic02spellbook.png", 27);
	...
	types[29] = ItemType("Eliksir Czerwony", 4, 1, 2, 2, 3, "./src/textures/Daily Doodles - Pixel Art Asset Pack/glass05red.png", 33);
